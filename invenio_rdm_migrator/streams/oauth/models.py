...
# FIXME: can be migrated as is? client_secret?
@dataclass
class ServerClient:
...
# FIXME: Needs re-hashing of {access,refresh}-token, since the secret key of the instance will change (transformer)
# FIXME: check scopes with RDM permissions levels
@dataclass
class ServerToken:
